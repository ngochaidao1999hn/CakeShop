...
namespace CakeShop.Infrastructure.Migrations
{
    ...
    [Migration("20211010023812_NutrientFacts")]
    partial class NutrientFacts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CakeShop.Domain.Entities.NutrientFact", b =>
                {
                    b.Property<int>("Nutrient_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("Nutrient_Calories")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Calories_from_Fat")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Carbohydrate")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Cholesterol")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Fat")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Protein")
                        .HasColumnType("int");

                    b.Property<int>("Nutrient_Sodium")
                        .HasColumnType("int");

                    b.Property<int>("Product_Id")
                        .HasColumnType("int");

                    b.HasKey("Nutrient_Id");

                    b.HasIndex("Product_Id")
                        .IsUnique();

                    b.ToTable("NutrientFacts");
                });
            ...
            modelBuilder.Entity("CakeShop.Domain.Entities.NutrientFact", b =>
                {
                    b.HasOne("CakeShop.Domain.Entities.Product", "Product")
                        .WithOne("NutrientFacts")
                        .HasForeignKey("CakeShop.Domain.Entities.NutrientFact", "Product_Id")
